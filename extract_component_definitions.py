#
# Creates new component code segments and json from the old XML
#
...
parser.add_argument('--file', type=str, nargs='?', default='experiment_xml/freetexttest.xml',
                    help='experiment.xml format filename')
parser.add_argument('--output_folder', type=str, nargs='?', default='new_components_test',
                    help='generated component output folder')
