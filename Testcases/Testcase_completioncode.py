# -*- coding: utf-8 -*-
"""
Example testing the Completion code
"""
...
# Define study
study_definition_description = dict(title='CompletionCode test',
...
# Define protocol
protocol_definition_descriptiopn = dict(name='CompletionCode test',
...
#%% Trial 1: CompletionCode

# Trial definition
trial_definition_specification =  dict(trial_definition=dict(name='CompletionCode', definition_data=dict(TrialType='CompletionCode page')))
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|This is a test of a CompletionCode component}}')))]))
