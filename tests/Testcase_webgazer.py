...
# Define study
study_definition_description = dict(title='WebGazer test',
                                    description="""This study tests the WebGazer trial component""",
                                    version=1,
                                    lock_question=1,
                                    enable_previous=1,
...
# Define protocol
protocol_definition_descriptiopn = dict(name='WebGazer test',
                                        ...
                                        description='This tests the WebGazer trial plugin',
                                        active=True)
