...
# Define study
study_definition_description = dict(title='LikertScale test',
...
# Define protocol
protocol_definition_descriptiopn = dict(name='LikertScale test',
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='AlignForStimuli test', definition_data=dict(TrialType='LikertScale')))
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|This is a test of a LikertScale component}}')))]))
