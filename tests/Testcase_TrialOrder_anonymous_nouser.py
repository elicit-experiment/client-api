...
# Define study
study_definition_description = dict(title='TrialOrder anonymous (random)',
                                    description="""This study tests the Trial Order component""",
                                    version=1,
                                    lock_question=1,
                                    enable_previous=1,
...
# Define protocol
protocol_definition_descriptiopn = dict(name='TrialOrder anonymous (random)',
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='Trial 1', definition_data=dict(TrialType='Trial 1')))
...
component_definition_description = dict(name='TextBlock',
                                        definition_data=dict(
                                            Instruments=[dict(
                                                Instrument=dict(
                                                    TextBlock=dict(
                                                        Text=("{{style|color: black;font-size: 100px;|Trial 1 defined}}" 
                                                              ))))]))
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='Trial 2', definition_data=dict(TrialType='Trial 2')))
trial_object = elicit_object.add_trial_definition(trial_definition=trial_definition_specification,
                                                  study_definition_id=study_object.id,
                                                  protocol_definition_id=protocol_object.id,
                                                  phase_definition_id=phase_object.id)
...
component_definition_description = dict(name='TextBlock',
                                        definition_data=dict(
                                            Instruments=[dict(
                                                Instrument=dict(
                                                    TextBlock=dict(
                                                        Text=("{{style|color: black;font-size: 100px;|Trial 2 defined}}" 
                                                              ))))]))
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='Trial 3', definition_data=dict(TrialType='Trial 3')))
trial_object = elicit_object.add_trial_definition(trial_definition=trial_definition_specification,
                                                  study_definition_id=study_object.id,
                                                  protocol_definition_id=protocol_object.id,
                                                  phase_definition_id=phase_object.id)
...
component_definition_description = dict(name='TextBlock',
                                        definition_data=dict(
                                            Instruments=[dict(
                                                Instrument=dict(
                                                    TextBlock=dict(
                                                        Text=("{{style|color: black;font-size: 100px;|Trial 3 defined}}" 
                                                              ))))]))
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='Trial 4', definition_data=dict(TrialType='Trial 4')))
trial_object = elicit_object.add_trial_definition(trial_definition=trial_definition_specification,
                                                  study_definition_id=study_object.id,
                                                  protocol_definition_id=protocol_object.id,
                                                  phase_definition_id=phase_object.id)
...
component_definition_description = dict(name='TextBlock',
                                        definition_data=dict(
                                            Instruments=[dict(
                                                Instrument=dict(
                                                    TextBlock=dict(
                                                        Text=("{{style|color: black;font-size: 100px;|Trial 4 defined}}" 
                                                              ))))]))
...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='Trial 5', definition_data=dict(TrialType='Trial 5')))
trial_object = elicit_object.add_trial_definition(trial_definition=trial_definition_specification,
                                                  study_definition_id=study_object.id,
                                                  protocol_definition_id=protocol_object.id,
                                                  phase_definition_id=phase_object.id)
...
component_definition_description = dict(name='TextBlock',
                                        definition_data=dict(
                                            Instruments=[dict(
                                                Instrument=dict(
                                                    TextBlock=dict(
                                                        Text=("{{style|color: black;font-size: 100px;|Trial 5 defined}}" 
                                                              ))))]))
...
for anonymous_participant in range(0,NUM_ANONYMOUS_USERS):   
    ...
    shuffle(trial_id)
    trial_id.append(int(trial_object_eoe.id)) #end of experiment is always in the end
