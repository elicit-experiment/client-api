...
make_trial('Freetext', 'video', 'row', dict(BoxWidth='50%'))
make_trial('Freetext', 'video_youtube', 'row', dict(BoxWidth='50px'))
make_trial('Freetext', 'audio', 'row')
make_trial('Freetext', 'image', 'row', dict(BoxHeight='100px'))
