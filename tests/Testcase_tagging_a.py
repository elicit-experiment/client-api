...
# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='TaggingA stimuli', definition_data=dict(TrialType='TaggingA')))
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|1: This is a test of a TaggingA component}}')))]))
...
component_definition_description = dict(name='TaggingA',
                                        definition_data=dict(Layout=dict(Type='column',
                                                            ...
                                                            Instruments=[dict(
                                                                    Instrument=dict(
                                                                        TaggingA=dict(
                                                                            HeaderLabel='This is a TaggingA with image stimuli',
                                                                            IsOptional='0',
                                                                            TextField='TextField',
                                                                            MaxNoOfSelections='2',
                                                                            MinNoOfSelections='0',
                                                                            ...
                                                                            SelectionTags=dict(
                                                                                Item=[
                                                                                    dict(Id='1', Label ='Selection-1'),
                                                                                    dict(Id='2', Label = 'Selection-2'),
                                                                                    dict(Id='3', Label = 'Selection-3')]),
...
#%% Trial 2: Tagging-A - no stimuli

# Trial definition
trial_definition_specification = dict(trial_definition=dict(name='TaggingA no stimuli', definition_data=dict(TrialType='TaggingA')))
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|2: This is a test of a TaggingA component}}')))]))
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|3: This is a test of a TaggingA component}}')))]))
...
component_definition_description = dict(name='TaggingA',
                                        definition_data=dict(Layout=dict(Type='column',
                                                            ...
                                                            Instruments=[dict(
                                                                    Instrument=dict(
                                                                        TaggingA=dict(
                                                                            HeaderLabel='TaggingA NO stimuli, NO UserTagBoxLabel',
                                                                            IsOptional='0',
                                                                            TextField='TextField',
                                                                            MaxNoOfSelections='2',
                                                                            MinNoOfSelections='0',
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|4: This is a test of a TaggingA component}}')))]))
...
component_definition_description = dict(name='TaggingA',
                                        definition_data=dict(Layout=dict(Type='column',
                                                            ...
                                                            Instruments=[dict(
                                                                    Instrument=dict(
                                                                        TaggingA=dict(
                                                                            HeaderLabel='TaggingA NO stimuli, NO UserTagBoxLabel, NO SelectionTagBoxLabel',
                                                                            IsOptional='0',
                                                                            TextField='TextField',
                                                                            MaxNoOfSelections='2',
                                                                            MinNoOfSelections='0',
...
component_definition_description = dict(name='HeaderLabel',
                                        definition_data=dict(
                                                Instruments=[dict(
                                                        Instrument=dict(
                                                                Header=dict(HeaderLabel='{{center|5: This is a test of a TaggingA component}}')))]))
...
component_definition_description = dict(name='TaggingA',
                                        definition_data=dict(Layout=dict(Type='row',
                                                                         ColumnWidthPercent=['0', '100']),
                                                             Instruments=[dict(
                                                                    Instrument=dict(
                                                                        TaggingA=dict(
                                                                            HeaderLabel='TaggingA ROW design, NO UserTagBoxLabel, NO SelectionTagBoxLabel',
                                                                            IsOptional='0',
                                                                            TextField='TextField',
                                                                            SelectionTagBoxLabel='SelectionTagBoxLabel',
                                                                            SelectionTags=dict(
